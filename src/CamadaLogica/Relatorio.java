...
//        banco.abrirConexao();
    ...
    public void ImprimirRelatorioPDFData(Date data, String ArqNome) throws JRException
    {//Passando pelo parametro. Orcamento e Pedido Only
        JFileChooser chooser = new JFileChooser();
        String caminho = "";
        File file = null;
    ...
    public void ImprimirRelatorioData(Date data, String ArqNome, String TituloRelatorio) throws JRException
    {
      //implementação da interface JRDataSource para DataSource ResultSet
      //chamando o relatório
        HashMap parametros = new HashMap();
